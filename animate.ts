...
export type VariantAnimateParameters<K extends string | symbol> = {
  variants: Record<
    K,
...
export type SimpleAnimateParameters = {
  keyframes: MotionKeyframesDefinition;
};

export type AnimateParameters<K extends string | symbol> = (
  | VariantAnimateParameters<K>
  | SimpleAnimateParameters
